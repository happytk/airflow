...
# dag = DAG(
#     dag_id=dag_id,
#     description='accutuning parse operation',
...
# def check_parse_result(ds, **kwargs):
#     import pickle
#     print(pickle.load(open('/workspace/output/parse.pkl', 'rb')))
#     print(pickle.load(open('/workspace/output/recommend_config.pkl', 'rb')))
#     print("Remotely received value of {} for key=message".
#           format(kwargs['dag_run'].conf['message']))


# check_result = PythonOperator(
#     task_id='check_parse_result',
#     provide_context=True,
#     python_callable=check_parse_result,
#     dag=dag,
# )
...
# start >> run >> check_result >> end
# # start >> write_xcom >> pod_task_xcom_result >> end
# # run >> end